...
public class Filtro implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		// TODO Auto-generated method stub
				...
				try {
					if (req.getRequestURI().indexOf("/LogisticaApp/javax.faces.resource/")!=-1) {
						autorizzato = true;
					} else {			
		        ...
		        { 	
		          if (autorizzato) {  
		              ...
		              resp.sendRedirect(request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+"/LogisticaApp/notAuthorized.xhtml");
		          }
		        }
	}
